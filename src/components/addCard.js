...
import { MyKeyboardAvoidingView, MyTextInput, GridTop, GridBottom, BigBlueText, BlueLightView, Button, ButtonGreen, ButtonText } from './styledComponents'
...
class addCard extends Component {
  ...
  onSubmitForm = () => {
    if (this.state.textQuestion === '' || this.state.textQuestion === 'Question'){
      this.setState({textQuestion: "Question", color: reddark})
    } else if (this.state.textAnswer === '' || this.state.textAnswer === 'Answer'){
        this.setState({textAnswer: "Answer", color: reddark})
    } else {
